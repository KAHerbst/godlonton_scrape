...
#m <- source_analysis(url = source_data[[2]][1], source = source_data[[1]][1], terms = c("prince, saudi", "federal"), title_selector = source_data[[4]][1], published_selector = source_data[[5]][1], text_selector = source_data[[6]][1], chain_base = source_data[[3]][1], depth = 4)
